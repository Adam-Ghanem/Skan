#ifndef SKAN_DISCOVERY_TCP_DISCOVERY_HPP
#define SKAN_DISCOVERY_TCP_DISCOVERY_HPP

#include "discovery/discovery_probe.hpp"

namespace skan::discovery {

class TcpDiscoveryProbe final : public DiscoveryProbe {
public:
...
#endif // SKAN_DISCOVERY_TCP_DISCOVERY_HPP
