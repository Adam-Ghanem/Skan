...
def validate_record(
    ...
    for provenance in record.provenance:
        ...
        if record.kind not in source.approved_data_classes:
            errors.append(f"source {provenance.source_id} is not approved for data class {record.kind}")
        if record.kind in source.blocked_data_classes:
            errors.append(f"source {provenance.source_id} is blocked for data class {record.kind}")
